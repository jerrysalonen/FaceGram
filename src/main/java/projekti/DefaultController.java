...
public class DefaultController {
    ...
    public String comment(@RequestParam String content, @PathVariable Long id) {
    ...
    @PostMapping("/user/{id}/imagegallery")
    public String imageGallery(Model model, @PathVariable Long id) {
        Authentication auth = SecurityContextHolder.getContext().getAuthentication();
        Account u = userRepo.findByUsername(auth.getName());
        model.addAttribute("loggedInUser", u);
        
        model.addAttribute("images", imageRepo.findByUser(u));
